...
public class SafeSenario {
    public static void main (String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread (new Runnable(){
            ...
            public void run(){
                ...
                for (int i = 1; i <= loop; i++){
                    System.out.println("thread name is " + threadName + " value is " + s.getNext());
                }
            }
        });
        ...
        System.out.println("current thread is befroe ending the threads " + Thread.currentThread().getName() + " current value is " +
                s.getNext());
